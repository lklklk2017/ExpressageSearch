...
import com.cdxxgc.expressagesearchdemo.db.DaoMaster;
import com.cdxxgc.expressagesearchdemo.db.DaoSession;
    ...
    public static DBManager getInstance() {
        if (null == mInstance) {
            synchronized (DBManager.class) {
                if (null == mInstance) {
                    return mInstance = new DBManager(MyApplication.getContext());
                }
            }
        }
        return mInstance;
